import React, { Children, isValidElement, createContext, useContext, useRef, useEffect, Fragment as Fragment$1, cloneElement } from 'react';
...
var elementsWithoutSlot = function elementsWithoutSlot(elements, name) {
  return Children.map(elements, function (element) {
    if (element.props && element.props.slot === name) return;
    return element;
  });
};
var findSlot = function findSlot(elements, name) {
  return Children.toArray(elements).find(function (_ref) {
...
function DiscordEmbed(_ref) {
  ...
  if (slots.fields) {
    if (! /*#__PURE__*/isValidElement(slots.fields)) {
  ...
  var content = {
    ...
    }, authorImage ? /*#__PURE__*/React.createElement("img", {
      src: authorImage,
      alt: "",
      className: "discord-author-image"
    }) : null, authorUrl ? /*#__PURE__*/React.createElement("a", {
      href: authorUrl,
      target: "_blank",
      rel: "noopener noreferrer"
    }, authorName) : /*#__PURE__*/React.createElement("span", null, authorName)),
    footer: /*#__PURE__*/React.createElement("div", {
      className: "discord-embed-footer"
    }, slots.footer && footerImage ? /*#__PURE__*/React.createElement("img", {
      src: footerImage,
      alt: "",
      className: "discord-footer-image"
    }) : null, /*#__PURE__*/React.createElement("span", null, slots.footer, slots.footer && timestamp ? /*#__PURE__*/React.createElement("span", {
      className: "discord-footer-separator"
    }, "\u2022") : null, timestamp ? /*#__PURE__*/React.createElement("span", null, parseTimestamp(timestamp)) : null)),
  ...
  }, /*#__PURE__*/React.createElement("div", null, authorName ? content.author : null, title ? content.title : null, /*#__PURE__*/React.createElement("div", {
    className: "discord-embed-description"
  }, slots["default"]), slots.fields, image ? /*#__PURE__*/React.createElement("img", {
    src: image,
    alt: "",
    className: "discord-embed-image"
  }) : null), thumbnail ? /*#__PURE__*/React.createElement("img", {
    src: thumbnail,
    alt: "",
...
var DiscordOptionsContext = /*#__PURE__*/createContext(DiscordDefaultOptions);
...
function DiscordMention(_ref) {
  var children = _ref.children,
      ...
      type = _ref.type;
  var options = useContext(DiscordOptionsContext) || DiscordDefaultOptions;
...
function DiscordMessage(_ref) {
  ...
  var authorInfo = {
    comfy: /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(AuthorInfo, {
    ...
    compact: /*#__PURE__*/React.createElement(Fragment$1, null, /*#__PURE__*/React.createElement("span", {
      className: "discord-message-timestamp"
    }, parseTimestamp(timestamp)), /*#__PURE__*/React.createElement(AuthorInfo, {
      author: profile.author,
      bot: profile.bot,
      roleColor: profile.roleColor
    }))
  ...
  if (slots.embeds) {
    if (! /*#__PURE__*/isValidElement(slots.embeds)) {
  ...
  }, !compactMode ? authorInfo.comfy : null, /*#__PURE__*/React.createElement("div", {
    className: "discord-message-body"
  }, compactMode ? authorInfo.compact : null, slots["default"], edited ? /*#__PURE__*/React.createElement("span", {
...
function DiscordMessages(_ref) {
  ...
  var messages = Children.map(children, function (element, index) {
...
export { DiscordDefaultOptions, DiscordEmbed, DiscordEmbedField, DiscordEmbedFields, DiscordMention, DiscordMessage, DiscordMessages, DiscordOptionsContext };
